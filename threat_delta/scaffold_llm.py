...
Authoring the *initial* baseline is the one place this tool sanctions LLM help:
producing the very first ``threat-model.yaml`` is
...
#
# This baseline was bootstrapped with LLM assistance: a ONE-TIME, OFFLINE
# draft. Component code_paths were discovered
